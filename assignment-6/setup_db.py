...
def select_student_grades(conn, student_no):
    cur = conn.cursor()
    cur.execute("SELECT course_id, grade FROM grades WHERE student_no=?", (student_no,))
...
def select_course_grades(conn, course_id):
    cur = conn.cursor()
    cur.execute("SELECT student_no, grade FROM grades WHERE course_id=?", (course_id,))
...
def select_student(conn, student_no):
    cur = conn.cursor()
